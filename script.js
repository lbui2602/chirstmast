...
function createGift() {
  ...
  const messages = [
    '🎁 Chúc em giáng sinh vui vẻeee',
    '🎄 Wo ai niiiiiii!',
    '⭐ Trương Thị Hiền Oanh, anh yêu emmmmmmmmm!',
    '🎅 Chúc mừng, em sẽ được nhận 1 món quà. Hãy nhận nó vào ngày 29/12.',
    '🎅 Chúc em luôn xinh đẹp và giỏi gianggg.',
  ];
